...
export default function EditCountryPage() {
  ...
  if (loading) {
    return <div style={{ padding: '48px', textAlign: 'center' }}><Loader className="spin" size={24} color="var(--clr-primary)" /></div>;
  }
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '12px' }}>
        <div>
          ...
          <h1 style={{ fontSize: '28px', fontFamily: 'var(--font-display)', margin: 0, color: 'var(--clr-text)' }}>Edit Country: {editForm.name}</h1>
        </div>
