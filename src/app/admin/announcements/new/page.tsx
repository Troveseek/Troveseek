          ...
          <div className={styles.card}>
            ...
            <div style={{ display: 'flex', gap: '16px', marginBottom: '16px' }}>
              <div className={styles.formGroup} style={{ flex: 1, margin: 0 }}>
                ...
                <input type="text" className={styles.formInput} value={title} onChange={e => setTitle(e.target.value)} required placeholder="e.g. Enterprise Software, Simplified" />
              </div>
              <div className={styles.formGroup} style={{ flex: 1, margin: 0 }}>
                <label className={styles.formLabel}>Main Title (AR)</label>
                <input type="text" className={styles.formInput} dir="rtl" value={titleAr} onChange={e => setTitleAr(e.target.value)} placeholder="العنوان الرئيسي" />
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '16px', marginBottom: '16px' }}>
              <div className={styles.formGroup} style={{ flex: 1, margin: 0 }}>
                ...
                <input type="text" className={styles.formInput} value={label} onChange={e => setLabel(e.target.value)} placeholder="e.g. SaaS Solutions" />
              </div>
              <div className={styles.formGroup} style={{ flex: 1, margin: 0 }}>
                <label className={styles.formLabel}>Eyebrow Label (AR) (Optional)</label>
                <input type="text" className={styles.formInput} dir="rtl" value={labelAr} onChange={e => setLabelAr(e.target.value)} placeholder="التسمية" />
              </div>
            </div>
