...
var password_1 = require("./src/lib/auth/password");
function createSuperAdmin() {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, existing, passwordHash, passwordHash, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    email = 'admin@troveseek.com';
                    password = 'Admin@TroveSeek#2024!';
                    _a.label = 1;
                case 1:
                ...
                case 9:
                    err_1 = _a.sent();
                    console.error('Failed to create superadmin:', err_1);
                    return [3 /*break*/, 11];
                case 10:
                    process.exit(0);
                    return [7 /*endfinally*/];
